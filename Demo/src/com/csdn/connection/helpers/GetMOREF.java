...
package com.csdn.connection.helpers;

import com.csdn.connection.Connection;
import com.csdn.connection.helpers.builders.*;
...
public class GetMOREF extends BaseHelper {
     ...
     * @param propCollectorRef The collector of the ManagedObjectReference
